...
export default function Home() {
  ...
  const isInView = (refs) => useInView(refs, { once: true, margin: "-50px" })
  ...
  return (
    <>
      <header className="main-container flex">
        <div className={`"sidebar" ${sidebar ? "translate-x-0" : "-translate-x-80"} md:translate-x-0 fixed z-50 transition-all duration-300 ease-in bg-[#040b14] text-white w-[300px] h-screen max-h-screen p-4 overflow-hidden`}>
          <div className="mt-6">
          ...
          <nav className="mt-4">
            <ul className="flex flex-col gap-1 p-2">
              <Link to="home" smooth={true} spy={true} onSetActive={() => setActive("home")} className="cursor-pointer py-2 hover:bg-slate-900 rounded-sm">
              ...
              <Link to="about" smooth={true} spy={true} onSetActive={() => setActive("about")} offset={-150} className="cursor-pointer py-2 hover:bg-slate-900 rounded-sm">
                <span className="flex gap-2 items-center">
              ...
              <Link to="skills" smooth={true} spy={true} onSetActive={() => setActive("skills")} offset={-150} className="cursor-pointer py-2 hover:bg-slate-900 rounded-sm">
                <span className="flex gap-2 items-center">
              ...
              <Link to="education" smooth={true} spy={true} onSetActive={() => setActive("education")} offset={-150} className="cursor-pointer py-2 hover:bg-slate-900 rounded-sm">
                <span className="flex gap-2 items-center">
              ...
              <Link to="experience" smooth={true} spy={true} onSetActive={() => setActive("experience")} offset={-150} className="cursor-pointer py-2 hover:bg-slate-900 rounded-sm">
                <span className="flex gap-2 items-center">
              ...
              <Link to="projects" smooth={true} spy={true} onSetActive={() => setActive("projects")} offset={-150} className="cursor-pointer py-2 hover:bg-slate-900 rounded-sm">
                <span className="flex gap-2 items-center">
              ...
              <Link to="contact" smooth={true} spy={true} onSetActive={() => setActive("contact")} offset={-150} className="cursor-pointer py-2 hover:bg-slate-900 rounded-sm">
                <span className="flex gap-2 items-center">
      ...
      <main className="body-container md:ml-[300px] transition-all duration-300 ease-in flex-1 overflow-x-hidden">
        <Element name="home">
          <section className="grid lg:grid-cols-2 min-h-screen bg-[#242735] lg:p-2 p-5 pt-10 lg:pt-0 text-white overflow-hidden">
            ...
            <div className="flex flex-col gap-2 md:gap-4 justify-center lg:min-h-screen lg:align-middle">
              ...
              <motion.button
                ...
                className="flex items-center gap-2 w-fit bg-violet-600 hover:bg-violet-700 transition duration-150 p-2 px-4 cursor-pointer rounded-lg my-4">
        ...
        <Element name="about">
          <section className="bg-[#00182a] min-h-screen text-white p-2">
            <motion.h2
              ref={ref}
              initial={{ opacity: 0, y: 50 }}
              animate={isInView(ref) ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.5 }}
            ...
            <div className="grid xl:grid-cols-2 mt-10 w-fit">
              <motion.div
                ref={aboutref}
                initial={{ opacity: 0, x: -50 }}
                animate={isInView(aboutref) ? { opacity: 1, x: 0 } : {}}
                transition={{ duration: 0.5, delay: 0.1 }}
                className="col1">
              ...
              <motion.div
                ...
                <ul className="flex flex-col gap-1 text-sm md:text-[16px] w-fit">
                  ...
                  <li className="flex items-center gap-2 md:gap-4 p-1 md:p-2">
                    ...
                    <strong>Email:</strong>
                    <span>maheshchaudhary845@gmail.com</span>
                  </li>
                </ul>
              </motion.div>
            </div>
        ...
        <Element name="skills">
          <section className="bg-[#001f1f] text-white p-2 min-h-screen">
            <motion.h2
              ref={skillRef}
              initial={{ opacity: 0, y: 50 }}
              animate={isInView(skillRef) ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.5 }}
              className="text-3xl font-semibold underline underline-offset-8 decoration-sky-300 mt-10">
              Skills
            </motion.h2>
            ...
            <div className="grid md:grid-cols-2 mt-5">
              {skills.map((skill, index) => {
                return <div key={index} className="w-full p-4">
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={isInView(skillRef) ? { opacity: 1 } : {}}
                    transition={{ duration: 0.5, delay: 0.2 }}
                  ...
                  <motion.div
                    initial={{ width: 0 }}
                    animate={isInView(skillRef) ? { width: "100%" } : {}}
                    transition={{ duration: 0.5 }}
                    className="w-full bg-gray-700 rounded-full h-3">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={isInView(skillRef) ? { width: `${skill.level}%` } : {}}
        ...
        <Element name="education">
          <section className="relative text-white p-2 min-h-screen">
              ...
              <motion.div
                ...
                <div className="mb-10 pl-6">
                  ...
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <h3 className="text-lg font-semibold">Class XII (Senior Secondary)</h3>
              ...
              <div className="my-16 ml-2 relative border-l-2 border-gray-600 pl-6 space-y-12">
                <div className="relative">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-400">UMIT Solutions | Aug 2025 - Oct 2025</p>
        ...
        <Element name="projects">
          <section className="bg-[#0f0818] text-white p-2 min-h-screen">
            <motion.h2
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
        ...
        <Element name="contact">
          <section className="relative text-white p-2 min-h-screen">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col xl:flex-row mt-20 gap-5 max-w-5xl mx-auto items-center">
                <motion.div
                  initial={{ opacity: 0, x: -50 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: 0.2 }}
                ...
                >
                  <form className="flex flex-col gap-4">
                    <input type="text" name="name" value={form.name} onChange={handleChange} className="bg-gray-800 p-4" placeholder="Name" />
                    <input type="email" name="email" value={form.email} onChange={handleChange} className="bg-gray-800 p-4" placeholder="Email" />
                    <input type="subject" name="subject" value={form.subject} onChange={handleChange} className="bg-gray-800 p-4" placeholder="Subject" />
                    <textarea type="text" name="message" value={form.message} onChange={handleChange} className="bg-gray-800 p-4 h-40" placeholder="Message" />
                    <button className="bg-cyan-500 p-4 cursor-pointer hover:bg-cyan-600">Send Message</button>
                  </form>
                </motion.div>
                ...
                >
                  <div className="flex">
                    ...
                    <div className="flex items-center max-w-full w-full h-16 sm:h-24 bg-gray-900">
                      <h3 className="p-2 text-[14px] sm:text-[16px]">maheshchaudhary845@gmail.com</h3>
                    </div>
                  </div>
                  <div className="flex">
                    <div className="flex justify-center items-center min-w-16 h-16 sm:w-24 sm:h-24 bg-gray-800">
                    ...
                    <div className="flex items-center max-w-full w-full h-16 sm:h-24 bg-gray-900">
                      <h3 className="p-2 text-[14px] sm:text-[16px]">+91 7807342244</h3>
                    </div>
                  </div>
